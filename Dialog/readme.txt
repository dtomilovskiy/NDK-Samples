...
Sample Description:
 ...
 When you run the application, you can display an alert dialog by swiping down
 from the top of the screen. An alert dialog is a simple dialog that contains a
